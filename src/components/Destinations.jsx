      ...
      {selectedDestination && (
        <motion.div
          ...
          <motion.div
            ...
            className="bg-gray-900 rounded-3xl max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 overflow-hidden max-h-[80vh] md:max-h-[90vh]"
            ...
            <div className="p-4 sm:p-6 flex flex-col overflow-y-auto scrollbar-hide">
              ...
              <h3 className="text-2xl sm:text-3xl font-serif font-bold mb-2 sm:mb-3">{selectedDestination.name}</h3>
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4 leading-relaxed line-clamp-3 sm:line-clamp-none">{selectedDestination.description}</p>

              <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="glass-effect p-2 sm:p-3 rounded-lg">
                  <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-gold-500 mb-1" />
                  <div className="text-xs text-gray-400">Durée</div>
                  <div className="text-sm font-bold">{selectedDestination.duration}</div>
                </div>
                <div className="glass-effect p-2 sm:p-3 rounded-lg">
                  <Users className="w-4 h-4 sm:w-5 sm:h-5 text-gold-500 mb-1" />
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-gold-500 to-yellow-400 text-black py-3 rounded-full text-sm sm:text-base font-bold hover:scale-105 transition-transform mt-auto flex-shrink-0">
                Réserver maintenant
              </button>
            </div>
          </motion.div>
